...
### Class for calculating the content (perptual), style, and recontrusction losses. The model can work by applying the masks or without masks for guidance.
class total_loss(nn.Module):
    """
    Class for calculating the loss during training and validation. It uses explicit guidance to the regions to be inpainted (it can work without)
    Losses:
    ...
    def __call__(self, x, y, mask):
        ...
        rec_loss_local = self.criterion_local(x*mask,y*mask)
